...
#define EXAMPLE_UART_NUM        (uart_port_t  )0
...
#define EXAMPLE_UART_TX_IO_NUM  (uart_port_t  )U0TXD_GPIO_NUM
#define EXAMPLE_UART_RX_IO_NUM  (uart_port_t  )U0RXD_GPIO_NUM
...
static esp_err_t uart_wakeup_config(void)
{
    ...
    ESP_RETURN_ON_ERROR(gpio_sleep_set_direction((gpio_num_t )EXAMPLE_UART_RX_IO_NUM, GPIO_MODE_INPUT), TAG, "Set uart sleep gpio failed");
    ESP_RETURN_ON_ERROR(gpio_sleep_set_pull_mode((gpio_num_t )EXAMPLE_UART_RX_IO_NUM, GPIO_PULLUP_ONLY), TAG, "Set uart sleep gpio failed");
