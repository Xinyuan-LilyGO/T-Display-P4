 ...
 * @LastEditTime: 2025-06-13 09:23:23
 * @License: GPL 3.0
 */
#include <stdio.h>
...
auto IIS_Bus = std::make_shared<Cpp_Bus_Driver::Hardware_Iis>(ES8311_ADC_DATA_IN, ES8311_DAC_DATA_OUT, ES8311_WS_LRCK, ES8311_BCLK, ES8311_MCLK);
