 ...
 * @LastEditTime: 2026-04-30 10:31:43
 * @License: GPL 3.0
 */
...
extern "C" void app_main(void) {
  ...
  esp32p4->InitGpioInterrupt(XL9535_INT,
      cpp_bus_driver::Tool::InterruptMode::kFalling,
      [](void* arg) -> void { g_interrupt_flag = true; });

  xl9535->SetGpioMode(
      cpp_bus_driver::Xl95x5::Pin::kIo2, cpp_bus_driver::Xl95x5::Mode::kOutput);
  xl9535->SetGpioMode(
      cpp_bus_driver::Xl95x5::Pin::kIo3, cpp_bus_driver::Xl95x5::Mode::kInput);
  ...
  while (1) {
    ...
    xl9535->GpioWrite(
        cpp_bus_driver::Xl95x5::Pin::kIo2, cpp_bus_driver::Xl95x5::Value::kLow);
    printf("Xl9535 io3: %d\n",
        xl9535->GpioRead(cpp_bus_driver::Xl95x5::Pin::kIo3));
    vTaskDelay(pdMS_TO_TICKS(1000));
  }
