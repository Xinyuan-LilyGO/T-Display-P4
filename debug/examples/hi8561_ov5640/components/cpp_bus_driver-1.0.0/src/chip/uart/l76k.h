 ...
 * @LastEditTime: 2025-03-24 10:05:29
 * @License: GPL 3.0
 */
...
#define GET_INFORMATION_TIMEOUT_COUNT 3 // 获取信息超时计数
    ...
    public:
         ...
         */
        size_t read_data(uint8_t *data, size_t length = 0);
         ...
         */
        bool get_info_data(std::shared_ptr<uint8_t[]> &data, size_t *length, uint8_t timeout_count = GET_INFORMATION_TIMEOUT_COUNT);
