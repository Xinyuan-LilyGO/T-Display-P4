 ...
 * @LastEditTime: 2025-03-12 14:14:34
 * @License: GPL 3.0
 */
...
{
    bool Hardware_Spi::begin(int32_t frequency, int32_t cs)
    {
        if (frequency == DEFAULT_CPP_BUS_DRIVER_VALUE)
        {
            frequency = DEFAULT_CPP_BUS_DRIVER_SPI_FREQUENCY;
        }
        ...
        assert_log(Log_Level::INFO, __FILE__, __LINE__, "hardware_spi config frequency: %d hz\n", frequency);
