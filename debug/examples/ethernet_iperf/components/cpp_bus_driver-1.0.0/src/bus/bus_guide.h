 ...
 * @LastEditTime: 2025-03-12 14:53:56
 * @License: GPL 3.0
 */
...
namespace Cpp_Bus_Driver
{
    ...
    public:
        ...
        virtual bool begin(int32_t frequency, int16_t address) = 0;
    ...
    public:
        ...
        virtual bool begin(int32_t frequency, int32_t cs) = 0;
    ...
    public:
        ...
        virtual bool read(void *data, uint32_t length) = 0;
