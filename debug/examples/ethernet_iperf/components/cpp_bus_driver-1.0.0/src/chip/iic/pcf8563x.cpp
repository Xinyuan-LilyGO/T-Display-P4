 ...
 * @LastEditTime: 2025-03-12 17:36:17
 * @License: GPL 3.0
 */
#include "pcf8563x.h"
...
namespace Cpp_Bus_Driver
{
    ...
    bool Pcf8563x::begin(int32_t frequency)
    {
        ...
        if (iic_init_list(_init_list, sizeof(_init_list)) == false)
        {
    ...
    bool Pcf8563x::set_clock_frequency_output(Out_Freq frequency)
    {
        uint8_t buffer = 0;
    ...
    bool Pcf8563x::run_timer(uint8_t n_value, Timer_Freq freq)
    {
        ...
        uint8_t buffer = 0B10000000 | static_cast<uint8_t>(freq);
