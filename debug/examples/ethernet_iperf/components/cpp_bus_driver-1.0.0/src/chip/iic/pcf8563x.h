...
#define PCF8563X_DEVICE_DEFAULT_ADDRESS 0x51
    ...
    public:
         ...
         * @param frequency 使用Clock_Frequency::配置
         * @return
         * @Date 2025-02-27 15:46:00
         */
        bool set_clock_frequency_output(Out_Freq frequency);
         ...
         * @param freq 使用Timer_Freq::配置，选择的频率越高定时的时间越精准
         * @return
         * @Date 2025-02-27 16:12:48
         */
        bool run_timer(uint8_t n_value, Timer_Freq freq);
