 ...
 * @LastEditTime: 2025-02-27 09:08:53
 * @License: GPL 3.0
 */
...
#define BQ27220YZFR_DEVICE_DEFAULT_ADDRESS 0x55
    ...
    {
    private:
#define BQ27220YZFR_DEVICE_ID 0x0220
        ...
        enum class Cmd
        {
            ...
            RO_STATE_OF_CHARGE_START = 0x2C,
            RO_STATE_OF_HEALTH_START = 0x2E,
    ...
    public:
         ...
         */
        uint16_t get_standby_current(void);
         ...
         */
        uint16_t get_max_load_current(void);
         ...
         * StateOfCharge() = RemainingCapacity() ÷ FullChargeCapacity()，四舍五入至最接近的整数百分点
         * @return
         * @Date 2025-02-26 17:23:27
         */
        uint16_t get_state_of_charge(void);

        /**
         * @brief 获取预测的电池健康百分比，实际为FullChargeCapacity() 占 DesignCapacity() 的百分比，范围为 0 至 100%，
         * StateOfHealth() = FullChargeCapacity() ÷ DesignCapacity()，四舍五入至最接近的整数百分点
         * @return
         * @Date 2025-02-26 17:23:42
         */
        uint16_t get_state_of_health(void);
