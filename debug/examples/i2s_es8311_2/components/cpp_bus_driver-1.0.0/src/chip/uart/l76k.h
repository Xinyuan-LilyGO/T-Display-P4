 ...
 * @LastEditTime: 2025-02-18 12:08:49
 * @License: GPL 3.0
 */
...
namespace Cpp_Bus_Driver
{
    ...
    {
    private:
#define GET_INFORMATION_TIMEOUT_COUNT 3 // 获取信息超时计数
    ...
    public:
        ...
        bool search_command(const char *cmd, const uint8_t *data, size_t data_length, size_t *search_index = nullptr);
        ...
        bool get_info_data(std::shared_ptr<uint8_t[]> &data, size_t *length);
