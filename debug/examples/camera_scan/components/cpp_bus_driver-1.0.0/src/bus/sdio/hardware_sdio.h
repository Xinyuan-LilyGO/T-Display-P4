 ...
 * @LastEditTime: 2025-03-27 09:02:53
 * @License: GPL 3.0
 */
#pragma once
...
namespace Cpp_Bus_Driver
{
    ...
    {
    private:
#define SDIO_BUS_INIT_TIMEOUT_COUNT 30
    ...
    public:
        ...
        std::unique_ptr<sdmmc_card_t> _sdio_handle = nullptr;

        Hardware_Sdio(int32_t clk, int32_t cmd, int32_t d0, int32_t d1,
                      ...
                      Sdio_Port port = Sdio_Port::SLOT_0)
