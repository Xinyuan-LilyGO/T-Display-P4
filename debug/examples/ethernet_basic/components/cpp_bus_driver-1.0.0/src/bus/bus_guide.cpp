 ...
 * @LastEditTime: 2025-01-06 13:37:56
 * @License: GPL 3.0
 */
...
{
    bool Bus_IIC_Guide::read(const uint8_t write_c8, uint8_t *read_d8)
    {
    ...
    bool Bus_IIC_Guide::read(const uint8_t write_c8, uint16_t *read_d16)
    {
        uint8_t buffer[2] = {0};
        ...
        *read_d16 = (static_cast<uint16_t>(buffer[1]) << 8) | buffer[0];
