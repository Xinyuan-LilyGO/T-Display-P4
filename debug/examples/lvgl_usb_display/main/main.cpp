...
#define EXAMPLE_MIPI_DSI_LCD_V_RES 1168
#define EXAMPLE_MIPI_DSI_LCD_HSYNC 28
#define EXAMPLE_MIPI_DSI_LCD_HBP 26
#define EXAMPLE_MIPI_DSI_LCD_HFP 20
#define EXAMPLE_MIPI_DSI_LCD_VSYNC 2
#define EXAMPLE_MIPI_DSI_LCD_VBP 22
#define EXAMPLE_MIPI_DSI_LCD_VFP 200
...
extern "C" void app_main(void)
{
    ...
    // XL9535->Cpp_Bus_Driver::Tool::pin_mode(HI8561_SCREEN_BL, Cpp_Bus_Driver::Tool::Pin_Mode::OUTPUT, Cpp_Bus_Driver::Tool::Pin_Status::PULLDOWN);
    // XL9535->Cpp_Bus_Driver::Tool::pin_write(HI8561_SCREEN_BL, 1);
    ...
    usb_display_vendor_config_t vendor_config_usb = DEFAULT_USB_DISPLAY_VENDOR_CONFIG(EXAMPLE_MIPI_DSI_LCD_H_RES, EXAMPLE_MIPI_DSI_LCD_V_RES,
                                                                                      24, mipi_dpi_panel);
    ESP_ERROR_CHECK(esp_lcd_new_panel_usb_display(&vendor_config_usb, &mipi_dpi_panel));
