 ...
 * @LastEditTime: 2025-03-19 09:48:10
 * @License: GPL 3.0
 */
...
#define ES8311_DEVICE_ID 0x8311
    ...
    public:
        ...
        /**
         * @brief 设置芯片电流状态
         *  @param enable [true]：启动，[false]：关闭进入低功耗模式
         * @return
         * @Date 2025-03-11 17:30:59
         */
        bool set_chip_current_status(bool enable);
         ...
         * @brief 设置SDP字节长度
         * @param dsp 使用Sdp::配置
         * @param Data_Length 使用Data_Length::配置
         * @return
         * @Date 2025-03-13 11:42:42
         */
        bool set_sdp_data_bit_length(Sdp sdp, Data_Bit_Length length);
