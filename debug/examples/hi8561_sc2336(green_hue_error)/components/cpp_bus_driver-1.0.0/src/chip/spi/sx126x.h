 ...
 * @LastEditTime: 2025-03-19 09:46:25
 * @License: GPL 3.0
 */
...
#define SX126X_DEFAULT_MAX_TRANSMIT_BUFFER_SIZE 255
    ...
    public:
         ...
         */
        bool assert_iqr_status(uint16_t irq_flag, Iqr_Status &status);
         ...
         */
        bool start_lora_transmit(Chip_Mode chip_mode, Fallback_Mode fallback_mode = Fallback_Mode::STDBY_XOSC,
    ...
    private:
        struct Param
        {
            ...
            struct
            {
                ...
                uint8_t payload_length = SX126X_DEFAULT_MAX_TRANSMIT_BUFFER_SIZE;
    ...
    public:
         ...
         * @Date 2025-02-19 09:17:55
         */
        bool start_gfsk_transmit(Chip_Mode chip_mode, Fallback_Mode fallback_mode = Fallback_Mode::STDBY_XOSC,
         ...
         */
        bool set_irq_pin_mode(Irq_Flag dio1_mode, Irq_Flag dio2_mode, Irq_Flag dio3_mode);
