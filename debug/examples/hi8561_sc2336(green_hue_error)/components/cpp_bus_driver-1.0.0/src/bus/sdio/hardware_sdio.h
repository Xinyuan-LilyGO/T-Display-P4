 ...
 * @LastEditTime: 2025-03-18 13:51:27
 * @License: GPL 3.0
 */
#pragma once
...
{
    class Hardware_Sdio : public Bus_Spi_Guide
    {
    private:
    ...
    public:
        Hardware_Sdio(int32_t mosi, int32_t sclk, int32_t miso = DEFAULT_CPP_BUS_DRIVER_VALUE,
