 ...
 * @LastEditTime: 2025-03-20 10:28:59
 * @License: GPL 3.0
 */
...
namespace Cpp_Bus_Driver
{
    ...
    public:
        ...
        bool search(const char *search_sample, size_t sample_length, const uint8_t *search_library, size_t search_library_length, size_t *search_index = nullptr);
